...
function HookGrid({ initialHooks }) {
    ...
    const filteredHooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["filterHooksByCategory"])(initialHooks, selectedCategory).filter((hook)=>hook.name.toLowerCase().includes(searchQuery.toLowerCase()) || hook.description.toLowerCase().includes(searchQuery.toLowerCase()));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dc870e9e._.js.map